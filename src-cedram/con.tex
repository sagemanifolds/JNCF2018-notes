...
As a result, all code is fully included in \soft{SageMath~8.4} and does not require
...
\item the possibility to use \soft{SymPy} as the symbolic backend, instead of
...
\begin{itemize}
\item adding more symbolic backends (\soft{Giac}, \soft{FriCAS}, ...);
